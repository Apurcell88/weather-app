...
const location = document.querySelector('[data-location]'); // const form = document.querySelector('form');
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _indexDOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./indexDOM */ "./src/indexDOM.js");

const form = document.querySelector('form');
const searchBar = document.querySelector('input');
form.addEventListener('submit', async e => {
  e.preventDefault();
  await (0,_indexDOM__WEBPACK_IMPORTED_MODULE_0__["default"])();
  searchBar.value = '';
});
})();
