...
async function displayWeather() {
  const weatherInfo = await (0,_index__WEBPACK_IMPORTED_MODULE_0__["default"])(); // capitalize the first letter of each word for sky and location
